...
cpimg = "https://unitedcamps.in/Images/IMG_1744262656.jpg"  
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    ...
                    [
                    InlineKeyboardButton("🦋ғᴏʟʟᴏᴡ ᴜs🦋" ,url="https://t.me/")                              
                ],           
            ]
      )
...
caption = (
        ...
        "➠ **ғᴏʀ ᴜsᴇ ᴍᴇ sᴇɴᴅ /jaibajrangbali.\n"
        "➠ **ғᴏʀ ɢᴜɪᴅᴇ sᴇɴᴅ /help."
)
...
async def edit_txt(client, message: Message):
    ...
    try:
        await message.reply_document(
            ...
            caption="📥**𝗘𝗱𝗶𝘁𝗲𝗱 𝗕𝘆 ➤ 🚩 𝐉𝐀𝐈 𝐁𝐀𝐉𝐑𝐀𝐍𝐆 𝐁𝐀𝐋𝐈 🚩**"
        )
    except Exception as e:
...
async def upload(bot: Client, m: Message):
    ...
    credit = "️[🚩 𝐉𝐀𝐈 𝐁𝐀𝐉𝐑𝐀𝐍𝐆 𝐁𝐀𝐋𝐈 🚩](https://t.me/)"
    if raw_text3 == '1':
        CR = '[🚩 𝐉𝐀𝐈 𝐁𝐀𝐉𝐑𝐀𝐍𝐆 𝐁𝐀𝐋𝐈 🚩](https://t.me/T)'
    elif raw_text3:
        try:
